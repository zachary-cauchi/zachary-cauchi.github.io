...
export default defineEventHandler(() => [
  {
    id: 3,
    title: {
      en: "Application Software Developer",
    },
    employer: {
      en: "Merqury Cybersecurity Ltd.",
    },
    department: {
      en: "Key Management",
    },
    address: {
      en: "University of Malta, TAKEOFF Business Incubator, 214, Msida, MSD 2080, Birkirkara, Malta",
    },
    website: {
      en: "https://www.merqury.eu/",
    },
    dateFrom: {
      year: 2023,
      month: 12,
    ...
    description: {
      en: `
Product development:
  • Develop and maintain key management products.
  • Develop key management and network monitoring tools to track performance of deployed hardware and software applications.
  • Contribute to architectural design of key management products and related infrastructure.
  • Assemble dashboards for displaying performance metrics in an understandable fashion.

Product and security testing:
  • Design, develop, and maintain, unit and integration tests for testing product software.
  • Test and diagnose security aspects of our products.
  • Deploy hardware and software to staging environments.

Security practices:
  • Set up OpenSSH on devices with mandatory Public-Key Authentication for improved security.
  • Integrate RusTLS into our software for improved TLS security.
  • Ensure Mutual TLS is enforced where possible on all network communications between our software and backend applications.
  • Inspect and resolve low-level TLS errors encountered during testing

Organisational:
  • Attend cybersecurity conferences to represent the company and network with potential clients/suppliers.
        `.trim(),
    },
  },
  {
